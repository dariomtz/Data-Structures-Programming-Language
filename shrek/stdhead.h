...
typedef enum {
    ...
    NO_RBRACE_FOR_IF, NO_RBRACE_FOR_WHILE, NO_RBRACE_FOR_FOR, NO_END_LINE_FOR_SENTENCE, BLOCK_DOESNT_EXIST, PARSER_DOESNT_EXIST, TOKEN_OUTSIDE_MAIN, REPEATED_NAME_FOR_FUNCTION, INVALID_PARAMS, SENTENCE_DOESNT_EXIST, INVALID_OPERATION,
}errorType;
